...
@section('content')
    <div class="container mt-4">
        <div class="bg-white rounded shadow p-4 mt-4">
            <h2 class="text-center fw-bold mb-3" style="letter-spacing: 1px;">CẬP NHẬT MÃ GIẢM GIÁ</h2>
                ...
                <form action="{{ route('admin.discount-codes.update', $discountCode->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="code" name="code" placeholder="VD: KM0001"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="state" id="active" value="active"
                                    {{ old('state', $discountCode->state) == 'active' ? 'checked' : '' }}>
                                <label class="form-check-label" for="active">Kích hoạt</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="state" id="inactive" value="inactive"
                                    {{ old('state', $discountCode->state) == 'inactive' ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" id="started_at" name="started_at"
                                   value="{{ old('started_at', optional($discountCode->started_at)->format('Y-m-d')) }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control" id="type" name="type">
                                ...
                                <option value="percent" {{ old('type', $discountCode->type) == 'percent' ? 'selected' : '' }}>Phần trăm</option>
                                <option value="fixed" {{ old('type', $discountCode->type) == 'fixed' ? 'selected' : '' }}>Số tiền cụ thể</option>
                            </select>
                            @error('type')
                            <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3" placeholder="Mô tả chi tiết">{{ old('description', $discountCode->description) }}</textarea>
                            @error('description')
                            <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="discount_amount" name="discount_amount" placeholder="VD: 10%"
                                   value="{{ old('discount_amount', $discountCode->discount_amount) }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="min_order_value" name="min_order_value" placeholder="VD: 200000"
                                   value="{{ old('min_order_value', $discountCode->min_order_value) }}">
