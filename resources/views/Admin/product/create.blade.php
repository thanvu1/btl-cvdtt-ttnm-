                ...
                <form action="{{ route('admin.products.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="code" name="code" placeholder="VD: SP0001" value="{{ old('code') }}">
                            @error('code')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="country" name="country" placeholder="VD: Việt Nam" value="{{ old('country') }}">
                            @error('country')
                            <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
