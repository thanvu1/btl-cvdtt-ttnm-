...
@section('content')
    <div class="container mt-4">
        <div class="bg-white rounded shadow p-4 mt-4">
            <h2 class="text-center fw-bold mb-3" style="letter-spacing: 1px;">THÊM SẢN PHẨM</h2>
            <div class="border p-3 mb-4">
                <div class="fw-bold mb-3" style="font-size: 1.25rem; letter-spacing: 1px;">THÔNG TIN SẢN PHẨM</div>
                <form action="{{ route('admin.products.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="price" name="price" placeholder="VD: 150000" value="{{ old('price') }}">
                            @error('price')
                            <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="stock" name="stock" placeholder="VD: 100" value="{{ old('stock') }}">
                            @error('stock')
                            <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
                        <!-- Hạn sử dụng -->
                        <div class="col-md-6 mb-3">
                            <label for="expiration_date" class="form-label fw-bold">Hạn sử dụng</label>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="country" name="country" placeholder="VD: Việt Nam" value="{{ old('country', $product->country ?? '') }}">
                            @error('country')
                        <div class="text-danger small">{{ $message }}</div>
                         @enderror
</div>
                    ...
                    <div class="text-end mt-4">
                        ...
                        <a href="{{ route('admin.products.index') }}" class="btn btn-secondary px-4 ms-2 rounded-pill">
